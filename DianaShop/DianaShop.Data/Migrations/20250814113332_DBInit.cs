    ...
    public partial class DBInit : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KioskAddresses", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    SizeCode = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinimumPurchase = table.Column<double>(type: "double", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GPSLocation_Kiosks_KioskId",
                        column: x => x.KioskId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    KiodID = table.Column<int>(type: "int", nullable: false),
                    Base64Image = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KioskCameras", x => x.Id);
                    table.ForeignKey(
                        name: "FK_KioskCameras_Kiosks_KiodID",
                        column: x => x.KiodID,
                        principalTable: "Kiosks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KioskImages", x => new { x.KioskId, x.ImageId });
                    table.ForeignKey(
                        name: "FK_KioskImages_Images_ImageId",
                        column: x => x.ImageId,
                        principalTable: "Images",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_KioskImages_Kiosks_KioskId",
                        column: x => x.KioskId,
                        principalTable: "Kiosks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SensorData_Kiosks_KioskID",
                        column: x => x.KioskID,
                        principalTable: "Kiosks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShiftSlot = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Schedules_KioskAddresses_AddressID",
                        column: x => x.AddressID,
                        principalTable: "KioskAddresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Schedules_Kiosks_KioskID",
                        column: x => x.KioskID,
                        principalTable: "Kiosks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Orders_StageStatus_StatusId",
                        column: x => x.StatusId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerPaid = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    ChangeReturn = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Payment_StageStatus_StatusId",
                        column: x => x.StatusId,
                        principalTable: "StageStatus",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VnPayTransaction_Payment_PaymentId",
            ...
            migrationBuilder.InsertData(
                table: "PaymentMethod",
                columns: new[] { "Id", "IsDelete", "MethodName" },
                values: new object[,]
                {
                    { 1, false, "Cash on Delivery" },
                    { 2, false, "VNPay" }
                });
            ...
            migrationBuilder.InsertData(
                table: "StageStatus",
                columns: new[] { "Id", "IsDelete", "StatusName" },
                values: new object[,]
                {
                    { 1, false, "Unpaid" },
                    { 2, false, "Paid" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GPSLocation_KioskId",
                table: "GPSLocation",
                column: "KioskId");

            migrationBuilder.CreateIndex(
                name: "IX_KioskCameras_KiodID",
                table: "KioskCameras",
                column: "KiodID");

            migrationBuilder.CreateIndex(
                name: "IX_KioskImages_ImageId",
                table: "KioskImages",
                column: "ImageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VnPayTransaction_PaymentId",
